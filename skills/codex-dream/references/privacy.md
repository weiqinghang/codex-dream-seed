...
paths, raw messages, the full user anchor, private capsules, and the `TASK-*` mapping. Never
quote credentials or unnecessarily reproduce business data in tool output.
