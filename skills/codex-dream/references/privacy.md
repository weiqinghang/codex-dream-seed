...
`TASK-*` references and minimal summaries. Do not write session UUIDs, `/Users/...` or
`/home/...` paths, `~/.codex` rollout locations, tokens, cookies, passwords, or raw transcripts.
