...
> 当前版本为 `0.2.0`，适合本地试用和框架共建。默认只支持 Codex 本机 rollout
...
```bash
codex-dream init ~/codex-dream-workspace --set-default
```
...
codex-dream set-default ~/codex-dream-workspace
```
